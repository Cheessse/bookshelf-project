import{S as y}from"./vendor-edf1012f.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))n(t);new MutationObserver(t=>{for(const i of t)if(i.type==="childList")for(const u of i.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&n(u)}).observe(document,{childList:!0,subtree:!0});function s(t){const i={};return t.integrity&&(i.integrity=t.integrity),t.referrerPolicy&&(i.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?i.credentials="include":t.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(t){if(t.ep)return;t.ep=!0;const i=s(t);fetch(t.href,i)}})();(()=>{const e=document.querySelector(".js-menu-container"),o=document.querySelector(".js-open-menu"),s=document.querySelector(".header-menu-icon"),n=()=>{const t=e.classList.contains("is-open");e.classList.toggle("is-open"),o.setAttribute("aria-expanded",!t),t?s.querySelector("use").setAttribute("href","./img/symbol-defs.svg#icon-burger"):s.querySelector("use").setAttribute("href","./img/symbol-defs.svg#icon-x")};o.addEventListener("click",n)})();const m=[{title:"Save the Children",url:"https://www.savethechildren.net/what-we-do/emergencies/ukraine-crisis",img:"../img/SaveChildren.png",img2x:"../img/SaveChildren2x.png"},{title:"Project HOPE",url:"https://www.projecthope.org/country/ukraine/",img:"./img/projectHOPE.png",img2x:"./img/projectHOPE2x.png"},{title:"UNITED24",url:"https://u24.gov.ua/uk",img:"./img/United24.png",img2x:"./img/United24_2x.png"},{title:"International Medical Corps",url:"https://internationalmedicalcorps.org/country/ukraine/",img:"./img/MedicalCorps.png",img2x:"./img/MedicalCorps2x.png"},{title:"Medicins Sans Frontieres",url:"https://www.msf.org/ukraine",img:"./img/MedicalSans.png",img2x:"./img/MedicalSans2x.png"},{title:"RAZOM",url:"https://www.razomforukraine.org/",img:"./img/RAZOM.png",img2x:"./img/RAZOM2x.png"},{title:"Action against hunger",url:"https://www.actionagainsthunger.org/location/europe/ukraine/",img:"./img/AgainstHunger.png",img2x:"./img/AgainstHunger2x.png"},{title:"World vision",url:"https://www.wvi.org/emergencies/ukraine",img:"./img/WorldVision.png",img2x:"./img/WorldVision.png"},{title:"Serhiy Prytula Charity Foundation",url:"https://prytulafoundation.org/en",img:"./img/SergiyPrytula.png",img2x:"./img/SergiyPrytula2x.png"}],b={direction:"vertical",navigation:{nextEl:".swiper-btn-next"},rewind:!0,allowTouchMove:!1,spaceBetween:20,slidesPerView:"auto",slidesPerGroup:6},c=new y(".swiper",b),r={nextBtn:document.querySelector(".swiper-btn-next"),list:document.querySelector(".swiper-wrapper"),btn:document.querySelector(".support-btn")},S=m.map((e,o)=>`<div class ="support-item swiper-slide">
            ...
            </div>`).join("");r.list.innerHTML=S;h();addEventListener("resize",h);function v(){c.slideNext(),(c.isBeginning||c.isEnd)&&k()}function h(){const e=r.btn.classList.contains("hidden");m.length>c.params.slidesPerGroup?(e&&r.btn.classList.remove("hidden"),r.nextBtn.addEventListener("click",v)):e||r.btn.classList.add("hidden")}function k(){r.btn.classList.toggle("support-btn-up")}const l="list";function w(e){const o=f();o.push(e),localStorage.setItem(l,JSON.stringify(o))}function f(){return JSON.parse(localStorage.getItem(l))||[]}const a={addToShoppingList:w,getAllBooks:f};document.querySelector(".popup-book-image");document.querySelector(".popup-book-title");document.querySelector(".popup-book-author");document.querySelector(".popup-book-review");document.querySelector(".popup-shopping-links-icon.amazon");document.querySelector(".popup-shopping-links-icon.book");const d=document.querySelector("#add"),g=document.querySelector(".under-button-text");g.hidden=!0;d.addEventListener("click",L);function L(e){if(e.target.disabled)return;const o=e.target.attributes.id.value;d.textContent==="Add to shopping list"?x(o):B(o)}function x(e){let o=a.getAllBooks();o.push(e),a.addToShoppingList(o),d.textContent="Remove from the shopping list",g.hidden=!1,updateShoppingList()}function B(e){let o=a.getAllBooks();o.splice(o.indexOf(e),1),a.addToShoppingList(o),d.textContent="Add to shopping list",g.hidden=!0,updateShoppingList()}const q="/project-team-6/assets/symbol-defs-f000629d.svg#icon-amazon",O="/project-team-6/assets/symbol-defs-f000629d.svg#icon-ibooks",A="/project-team-6/assets/symbol-defs-f000629d.svg#icon-trash",p=document.querySelector(".shopping-list-default-div");function M(){const e=JSON.parse(localStorage.getItem(l))||[],o=document.querySelector(".shopping-list-render");if(e.length===0)p.style.display="block";else{const n=e.map(t=>`
       <div class="card">
  ...
  `).join("");o.insertAdjacentHTML("beforeend",n)}document.querySelectorAll(".delete-btn").forEach(n=>{n.addEventListener("click",()=>{const t=n.getAttribute("data-book-id");$(t);const i=n.closest(".card");i&&i.remove(),E()})})}M();function $(e){const o=getLocalStorageItem(l);if(!o||o.length===0)return;const s=o.filter(n=>n._id!==e);toLocalStorage(l,s)}function P(){return document.querySelector(".shopping-list-render").children.length===0}function E(){const e=document.querySelector(".support-ukraine");P()?(p.style.display="block",e.style.display="none"):(p.style.display="none",e.style.display="block")}
//# sourceMappingURL=shopping-list-c0f43e71.js.map
