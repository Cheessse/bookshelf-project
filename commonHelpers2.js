import{S as a}from"./assets/modal-window-30c8dae1.js";import"./assets/vendor-2eb9cd29.js";const l="/project-team-6/assets/symbol-defs-f000629d.svg#icon-amazon",n="/project-team-6/assets/symbol-defs-f000629d.svg#icon-ibooks",d="/project-team-6/assets/symbol-defs-f000629d.svg#icon-trash",i=document.querySelector(".shopping-list-default-div");function p(){const s=JSON.parse(localStorage.getItem(a))||[],o=document.querySelector(".shopping-list-render");if(s.length===0)i.style.display="block";else{const t=s.map(e=>`
       <div class="card">
